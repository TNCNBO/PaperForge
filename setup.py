...
def read_long_description():
    try:
        ...
        return "PaperForge: An AI-powered research platform that converts academic papers into working code automatically using multi-agent systems"
...
setuptools.setup(
    ...
    description="PaperForge: An AI-powered research platform that converts academic papers into working code automatically using multi-agent systems",
    long_description=long_description,
    long_description_content_type="text/markdown",
    packages=setuptools.find_packages(
        exclude=("tests*", "docs*", ".history*", ".git*", ".ruff_cache*")
    ),
    py_modules=["paperforge"],
    classifiers=[
