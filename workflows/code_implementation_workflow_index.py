...
async def main():
    ...
    if test_success:
        ...
        plan_file = "/data2/bjdwhzzh/project-hku/Deepcode_collections/DeepCode/paperforge_lab/papers/54_only_code_gen/initial_plan.txt"
        # plan_file = "/data2/bjdwhzzh/project-hku/Code-Agent2.0/Code-Agent/deepcode-mcp/agent_folders/papers/1/initial_plan.txt"
        target_directory = "/data2/bjdwhzzh/project-hku/Deepcode_collections/DeepCode/paperforge_lab/papers/54_only_code_gen/"
