#!/usr/bin/env python3
"""
PaperForge - AI Research Engine Launcher
...
def launch_paper_test(paper_name: str, fast_mode: bool = False):
    ...
    try:
        ...
        if result.returncode == 0:
            ...
            print(" Files are ready in paperforge_lab/papers/")
            print("\n Next steps:")
...
📁 Available papers:""")
    ...
    print("🌐 Starting PaperForge web interface...")
    ...
    try:
        ...
        print(f"\n❌ Failed to start PaperForge: {e}")
        print("Please check if Streamlit is properly installed.")
        sys.exit(1)
    except KeyboardInterrupt:
        print("\n\n🛑 PaperForge server stopped by user")
        print("Thank you for using PaperForge! 🧬")
    except Exception as e:
        print(f"\n❌ Unexpected error: {e}")
