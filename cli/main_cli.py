#!/usr/bin/env python3
"""
PaperForge CLI - Open-Source Code Agent
PaperForge CLI - 开源代码智能体
...
{Colors.CYAN}╔══════════════════════════════════════════════════════════════════════════════╗
║                                                                              ║
║    {Colors.BOLD}{Colors.MAGENTA}🧬 PaperForge - Open-Source Code Agent{Colors.CYAN}                              ║
║                                                                              ║
...
def parse_arguments():
    ...
    parser = argparse.ArgumentParser(
        description="PaperForge CLI - Open-Source Code Agent by Data Intelligence Lab @ HKU",
